...
<body>
 ...
 <form class="form" method="post" action="<?= site_url('login/proses')?>">
              <div class="card-body">
...
<!--                       <div class="float-right">
            ...
            <div class="mt-5 text-muted text-center">
              Don't have an account? <a href="<?= site_url('welcome/newakun')?>">Create One</a>
            </div>
